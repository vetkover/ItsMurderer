...
public class checkingFiles {
    static String appDir = System.getProperty("user.dir");
        public static void checkDirectory() {
            String directoryPath = appDir + "/plugins/ItsMurderer";
    ...
    public static void checkFiles() {
        File jsonFile = new File(appDir + "/plugins/ItsMurderer/list.json");
        File configFile = new File(appDir + "/plugins/ItsMurderer/config.yaml");
